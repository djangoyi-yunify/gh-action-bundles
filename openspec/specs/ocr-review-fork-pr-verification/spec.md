# OCR Review Fork PR Verification

## Purpose

Verify that the `ocr-review` Composite Action behaves correctly and securely for pull requests opened from fork repositories.
